...
export const Body = () => {
  ...
  const [values, setValues] = useState("1094884731")
  ...
  const handleSubmit = () =>{
     if (values === '1094884731') {
      ...
      alert("error cedula no encontrada")
     }
  }
  ...
  return (
    <>
      {isloading ?
           <Loading />
            :
            <div className="bg-slate-500 h-screen overflow-auto md:overflow-auto  pb-5 md:pb-10">
